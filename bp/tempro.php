...
if(isset($_GET['id'])){
$r_id = $_GET['id'];
    $sql="SELECT * FROM profile WHERE roll_no = {$r_id} AND approved  = 0";
...
Your profile has been added, It will be displayed within 24 hours in view profiles. Note down the following token for editing in future purposes.<br>
...
{
  ?>
<h1 align="center"><b>Error !! Try Again..</b></h1>
