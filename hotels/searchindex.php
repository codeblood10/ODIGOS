...
<!-- nav section end-->
    ...
    <div class="container-fluid" id="welcome" style="margin-bottom:20px; padding-left:0px; padding-right:0px; margin-top:50px">
	    <div class="row">
		    <div class="col-md-3">
			    <img src="h_img/food1.jpg" height="100px" width="200px">
			</div>
		    <div class="col-md-6 w3-hide-small w3-hide-medium">
			    <h2><b font="red">Best Hotels and Restaurants nearby BIET Jhansi</b></h2>
			</div>
			<div class="col-md-3 w3-hide-small w3-hide-medium" id="search">
    ...
    <div class="container-fluid" align="center" id="sr">
...
<?php
$sql_recent = "SELECT * FROM hotels  WHERE LOWER(name) LIKE LOWER('%".$hsearch."%') ";
...
$sql = "SELECT * FROM hotels WHERE LOWER(name) LIKE LOWER('%".$hsearch."%') ORDER BY od_id DESC LIMIT $per_page OFFSET $row_start ";
...
if($prev_page)
{
    echo " <li><a href='$_SERVER[SCRIPT_NAME]?Page=$prev_page&seah=$hsearch'>Back</a></li> ";
}

for($i=1; $i<=$num_pages; $i++){
    if($i != $page)
    {
        /*echo "<li><a href='$_SERVER[SCRIPT_NAME]?Page=$i&seah=$hsearch'>$i</a> </li>";*/
    }
    else
    {
        /*echo "<li> $i </li>";*/
...
if($page!=$num_pages)
{
    echo "<li> <a href ='$_SERVER[SCRIPT_NAME]?Page=$next_page&seah=$hsearch'>Next</a></li> ";
}
