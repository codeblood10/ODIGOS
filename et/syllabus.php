...
<style>  
 ...
 body
 {  
   background-image:url("EXAMTIME.JPG") ; 
    
 }  

   
.modal-content{background-image:url("sch.png");}
...
<!-- nav section end-->
 <!-- Trigger the modal with a button -->
  <div class="wrapper">
	...
	<h4 style="font-size:50px;color:white;text-shadow: 1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue;">SYLLABUS</h2>
    ...
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        <div class="modal-header">
		 ...
		 <form action="getsyllabus.php" METHOD ="POST"  data-async data-target="#myModal" class="form-horizontal text-center">
                 ...
                 <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <label class="control-label">BRANCH CODE:</label>
                            <input class="form-control text-center"  type="text" placeholder="cs,ee,ch,ec,it,ce,me" value="" name="branch" required="required"/>
                          </div>
                      </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" style="padding:25px 25px;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 align="center"><span class="glyphicon glyphicon-paperclip"></span>&nbsp;Give Your Suggestion!!</h4>
            </div>
            <!--modal header ends-->
            <!--modal body starts-->
